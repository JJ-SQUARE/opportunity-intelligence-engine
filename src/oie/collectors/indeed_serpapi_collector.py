...
class IndeedSerpAPICollector(BaseJobCollector):
    collector_name = "indeed_serpapi"

    def _load_legacy_callable(self):
        function_candidates = [
            ("collectors.discovery.indeed_serpapi", "collect_jobs"),
            ("collectors.discovery.indeed", "collect_jobs"),
            ("collectors.indeed_serpapi", "collect_jobs"),
        ]
        ...
        class_candidates = [
            ("collectors.discovery.indeed_serpapi", "IndeedSerpApiCollector"),
        ]
