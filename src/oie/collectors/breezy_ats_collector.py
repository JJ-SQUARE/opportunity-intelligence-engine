...
class BreezyATSCollector(BaseJobCollector):
    collector_name = "breezy"

    def _load_legacy_callable(self):
        function_candidates = [
            ("collectors.ats.breezy_hr", "collect_jobs"),
            ("collectors.ats.breezy_collector", "collect_jobs"),
            ("collectors.breezy", "collect_jobs"),
        ]
        ...
        class_candidates = [
            ("collectors.ats.breezy_hr", "BreezyHRCollector"),
        ]
