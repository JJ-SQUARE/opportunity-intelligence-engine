...
class GreenhouseATSCollector(BaseJobCollector):
    collector_name = "greenhouse"

    def _load_legacy_callable(self):
        function_candidates = [
            ("collectors.ats.greenhouse", "collect_jobs"),
            ("collectors.ats.greenhouse_collector", "collect_jobs"),
            ("collectors.greenhouse", "collect_jobs"),
        ]
        ...
        class_candidates = [
            ("collectors.ats.greenhouse", "GreenhouseCollector"),
        ]
