...
class SmartRecruitersATSCollector(BaseJobCollector):
    collector_name = "smartrecruiters"

    def _load_legacy_callable(self):
        function_candidates = [
            ("collectors.ats.smartrecruiters", "collect_jobs"),
            ("collectors.ats.smartrecruiters_collector", "collect_jobs"),
            ("collectors.smartrecruiters", "collect_jobs"),
        ]
        ...
        class_candidates = [
            ("collectors.ats.smartrecruiters", "SmartRecruitersCollector"),
        ]
