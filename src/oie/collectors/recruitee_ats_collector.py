...
class RecruiteeATSCollector(BaseJobCollector):
    collector_name = "recruitee"

    def _load_legacy_callable(self):
        function_candidates = [
            ("collectors.ats.recruitee", "collect_jobs"),
            ("collectors.ats.recruitee_collector", "collect_jobs"),
            ("collectors.recruitee", "collect_jobs"),
        ]
        ...
        class_candidates = [
            ("collectors.ats.recruitee", "RecruiteeCollector"),
        ]
