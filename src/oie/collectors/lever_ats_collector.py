...
class LeverATSCollector(BaseJobCollector):
    collector_name = "lever"

    def _load_legacy_callable(self):
        function_candidates = [
            ("collectors.ats.lever", "collect_jobs"),
            ("collectors.ats.lever_collector", "collect_jobs"),
            ("collectors.lever", "collect_jobs"),
        ]
        ...
        class_candidates = [
            ("collectors.ats.lever", "LeverCollector"),
        ]
