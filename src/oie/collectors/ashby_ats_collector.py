...
class AshbyATSCollector(BaseJobCollector):
    collector_name = "ashby"

    def _load_legacy_callable(self):
        function_candidates = [
            ("collectors.ats.ashby", "collect_jobs"),
            ("collectors.ats.ashby_collector", "collect_jobs"),
            ("collectors.ashby", "collect_jobs"),
        ]
        ...
        class_candidates = [
            ("collectors.ats.ashby", "AshbyCollector"),
        ]
