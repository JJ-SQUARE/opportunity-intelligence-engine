...
class RunAnalyticsExportService:
    ...
    def export_json(self, analytics: Dict[str, Any]) -> str:
        output_dir = self._get_output_dir()
        out_path = output_dir / "run_analytics.json"
        ...
        self.ctx.paths["run_analytics_json"] = str(out_path)
        return str(out_path)
